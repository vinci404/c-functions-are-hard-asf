...
```
someone actually fix my code like woahhhh
...
int main () {
	...
	int up;
	int upp;
    printf("\nPut two numbers: "); // galing sa checker function
	scanf("%d %d", &up , &upp);  // galing sa checker function
	checker(up, upp) //checker (0, 0);
	line ();
